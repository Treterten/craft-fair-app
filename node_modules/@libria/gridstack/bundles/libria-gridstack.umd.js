(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@libria/gridstack', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory((global.libria = global.libria || {}, global.libria.gridstack = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common));
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/components/gridstack.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /** @type {?} */
    var _sequence$1 = 0;
    var GridstackComponent = /** @class */ (function () {
        function GridstackComponent(_zone, _el, _renderer, _gridstackService) {
            ...
            this.gsresizestop = new core.EventEmitter();
         ...
         * @return {?}
         */
        GridstackComponent.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
            ...
            function () {
                ...
                if (_this._isValueTrue(_this.animate)) {
                    _this._renderer.setAttribute(_this._el.nativeElement, 'data-gs-animate', 'true');
                }
                _this._setAttributeIfNotUndefined('data-gs-width', _this.width);
                _this._setAttributeIfNotUndefined('data-gs-height', _this.height);
                /** @type {?} */
                var width = _this.width || (_this.options || {}).width;
                if (!_.isNull(width) && !_.isUndefined(width)) {
                    _this._renderer.addClass(_this._el.nativeElement, "grid-stack-" + width);
                }
                /** @type {?} */
                var el = ((/** @type {?} */ ($(_this._el.nativeElement)))).gridstack(_this.options);
                $(el).data('generated-id', _this.generatedId);
                _this._gridstack = $(el).data('gridstack');
                _this._gridstackService.addGrid(_this);
                // Hook events
                $(_this._el.nativeElement).on('added', (/**
                 * @param {?} evt
                 * @param {?} items
                 * @return {?}
                 */
                function (evt, items) {
                    /** @type {?} */
                    var itemsOfCurrentGrid = _this._gridstackService.getGridItems(_this.generatedId);
                    /** @type {?} */
                    var existingItemIds = ((/** @type {?} */ (_this._gridstack))).grid.nodes.map((/**
                     * @param {?} i
                     * @return {?}
                     */
                    function (i) { return $(i.el)
                        .attr('class')
                        .split(/\s+/)
                        .find((/**
                     * @param {?} s
                     * @return {?}
                     */
                    function (s) { return s.startsWith('lb-generated-id-'); }))
                        .replace('lb-generated-id-', ''); }));
                    /** @type {?} */
                    var itemsToAdd = existingItemIds.filter((/**
                     * @param {?} i
                     * @return {?}
                     */
                    function (i) { return !itemsOfCurrentGrid.some((/**
                     * @param {?} ei
                     * @return {?}
                     */
                    function (ei) { return ei.generatedId === i; })); }));
                    itemsToAdd.forEach((/**
                     * @param {?} i
                     * @return {?}
                     */
                    function (i) { return _this._gridstackService.attachGridItem(_this.generatedId, i); }));
                    _this.added.emit(items);
                }));
                $(_this._el.nativeElement).on('change', (/**
                 * @param {?} evt
                 * @param {?} items
                 * @return {?}
                 */
                ...
                $(_this._el.nativeElement).on('dragstart', (/**
                 * @param {?} evt
                 * @param {?} ui
                 * @return {?}
                 */
                ...
                $(_this._el.nativeElement).on('dragstop', (/**
                 * @param {?} evt
                 * @param {?} ui
                 * @return {?}
                 */
                function (evt, ui) {
                    _this.dragstop.emit(evt);
                }));
                $(_this._el.nativeElement).on('resizestart', (/**
                 * @param {?} evt
                 * @param {?} ui
                 * @return {?}
                 */
                function (evt, ui) {
                    _this.resizestart.emit(evt);
                }));
                $(_this._el.nativeElement).on('gsresizestop', (/**
                 * @param {?} evt
                 * @param {?} ui
                 * @return {?}
                 */
                function (evt, ui) {
                    _this.gsresizestop.emit(evt);
                }));
                $(_this._el.nativeElement).on('removed', (/**
                 * @param {?} evt
                 * @param {?} items
                 * @return {?}
                 */
                function (evt, items) {
                    ...
                    function (s) { return s.startsWith('lb-generated-id-'); }))
                        .replace('lb-generated-id-', ''); }));
                    /** @type {?} */
                    var itemsToDelete = itemsOfCurrentGrid.filter((/**
                     * @param {?} i
                     * @return {?}
                     */
                    function (i) { return !existingItemIds.some((/**
                     * @param {?} ei
                     * @return {?}
                     */
                    function (ei) { return ei === i.generatedId; })); }));
                    itemsToDelete.forEach((/**
                     * @param {?} i
                     * @return {?}
                     */
                    function (i) { return _this._gridstackService.detachGridItemIfExists(i.generatedId); }));
         ...
         * @return {?}
         */
        GridstackComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
            /** @type {?} */
            var heightChanges = changes.height;
            /** @type {?} */
            var optionsChanges = changes.options;
            ...
            if (optionsChanges && !optionsChanges.isFirstChange()) {
                /** @type {?} */
                var prev = optionsChanges.previousValue;
                /** @type {?} */
                var curr = optionsChanges.currentValue;
         ...
         * @return {?}
         */
        GridstackComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
        function () {
            var _this = this;
         ...
         * @return {?}
         */
        GridstackComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        GridstackComponent.prototype._updateGridstackHeight = /**
         * @private
         * @param {?} height
         * @return {?}
         */
         ...
         * @return {?}
         */
        GridstackComponent.prototype._handleItemChanges = /**
         * @private
         * @param {?} items
         * @return {?}
         */
        function (items) {
            var _this = this;
            /** @type {?} */
            var itemsOfCurrentGrid = this._gridstackService.getGridItems(this.generatedId);
            /** @type {?} */
            var itemsToAdd = items.filter((/**
             * @param {?} i
             * @return {?}
             */
            function (i) { return !itemsOfCurrentGrid.some((/**
             ...
             * @return {?}
             */
            function (w) { return w.generatedId === i.generatedId; })); }));
            /** @type {?} */
            var itemsToRemove = itemsOfCurrentGrid.filter((/**
             * @param {?} w
             * @return {?}
             */
            function (w) { return !items.some((/**
             * @param {?} i
             * @return {?}
             */
            function (i) { return i.generatedId === w.generatedId; })); }));
            this._gridstack.batchUpdate();
            itemsToAdd.forEach((/**
             * @param {?} i
             * @return {?}
             */
            function (i) { return _this._addItem(i); }));
            itemsToRemove.forEach((/**
             * @param {?} i
             * @return {?}
             */
            function (i) { return _this._removeItem(i); }));
         ...
         * @return {?}
         */
        GridstackComponent.prototype._addItem = /**
         * @private
         * @param {?} item
         * @return {?}
         */
        function (item) {
             ...
             */
            function () {
                if (_this._gridstack.willItFit(+item.x, +item.y, +item.width, +item.height, _this._isValueTrue(item.autoPosition))) {
         ...
         * @return {?}
         */
        GridstackComponent.prototype._removeItem = /**
         * @private
         * @param {?} item
         * @return {?}
         */
         ...
         * @return {?}
         */
        GridstackComponent.prototype._setAttributeIfNotUndefined = /**
         * @private
         * @param {?} attrName
         * @param {?} val
         * @return {?}
         ...
         * @return {?}
         */
        GridstackComponent.prototype._isValueTrue = /**
         * @private
         * @param {?} val
         * @return {?}
         */
        ...
        GridstackComponent.propDecorators = {
            gridstackItems: [{ type: core.ContentChildren, args: [GridstackItemComponent,] }],
            ...
            dragstop: [{ type: core.Output }],
            resizestart: [{ type: core.Output }],
            gsresizestop: [{ type: core.Output }]
        };
        return GridstackComponent;
    }());
    if (false) {
        /** @type {?} */
        GridstackComponent.prototype.gridstackItems;
        /** @type {?} */
        GridstackComponent.prototype.options;
        /** @type {?} */
        GridstackComponent.prototype.animate;
        /** @type {?} */
        GridstackComponent.prototype.width;
        /** @type {?} */
        GridstackComponent.prototype.height;
        /** @type {?} */
        GridstackComponent.prototype.change;
        /** @type {?} */
        GridstackComponent.prototype.added;
        /** @type {?} */
        GridstackComponent.prototype.removed;
        /** @type {?} */
        GridstackComponent.prototype.dragstart;
        /** @type {?} */
        GridstackComponent.prototype.dragstop;
        /** @type {?} */
        GridstackComponent.prototype.resizestart;
        /** @type {?} */
        GridstackComponent.prototype.gsresizestop;
        /** @type {?} */
        GridstackComponent.prototype.generatedId;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._gridstack;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._ngUnsubscribe;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._zone;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._el;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._renderer;
        /**
         * @type {?}
         * @private
         */
        GridstackComponent.prototype._gridstackService;
    }

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/gridstack.module.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
...
//# sourceMappingURL=libria-gridstack.umd.js.map
